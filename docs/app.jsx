...
function TripsScreen({ trips, onSelect, onAdd, onRestore, onShare, onDelete, loading, userData, onOpenCompanion, myUid, onOpenNotifs, unreadCount }) {
  ...
  return (
    <div style={{ minHeight:'100vh', background:COLORS.bg, paddingBottom:90, position:'relative' }}>
      {/* 프로필 버튼 */}
      ...
      <div style={{
        ...
        <div style={{ fontFamily:SERIF, fontSize:34, color:COLORS.ink, letterSpacing:'-0.02em' }}>My Trips<span style={{fontFamily:'monospace',fontSize:11,color:COLORS.mute,marginLeft:8}}>v383</span></div>
      </div>
      {loading
...
function HomeScreen({ trip, onOpenDay, onOpenHotel, onOpenHotelSheet, city, onPickCity,
  ...
  return (
    <div style={{ background:COLORS.bg, minHeight:'100vh', paddingBottom:90, position:'relative' }}>
      {/* My Trips 뒤로 버튼 */}
      {onBack && (
...
const CITY_DB = [
  ...
  // ── 일본 도시 ──
  { key:'tokyo',       kor:'도쿄',       eng:'Tokyo',          flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:35.6762,  lon:139.6503  },
  { key:'osaka',       kor:'오사카',     eng:'Osaka',          flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:34.6937,  lon:135.5023  },
  { key:'kyoto',       kor:'교토',       eng:'Kyoto',          flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:35.0116,  lon:135.7681  },
  { key:'sapporo',     kor:'삿포로',     eng:'Sapporo',        flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:43.0618,  lon:141.3545  },
  { key:'hokkaido',    kor:'홋카이도',   eng:'Hokkaido',       flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:43.2203,  lon:142.8635  },
  { key:'okinawa',     kor:'오키나와',   eng:'Okinawa',        flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:26.2124,  lon:127.6809  },
  { key:'fukuoka',     kor:'후쿠오카',   eng:'Fukuoka',        flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:33.5902,  lon:130.4017  },
  { key:'hiroshima',   kor:'히로시마',   eng:'Hiroshima',      flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:34.3853,  lon:132.4553  },
  { key:'nara',        kor:'나라',       eng:'Nara',           flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:34.6851,  lon:135.8048  },
  { key:'kobe',        kor:'고베',       eng:'Kobe',           flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:34.6901,  lon:135.1956  },
  { key:'nagasaki',    kor:'나가사키',   eng:'Nagasaki',       flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:32.7503,  lon:129.8779  },
  { key:'kanazawa',    kor:'가나자와',   eng:'Kanazawa',       flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:36.5944,  lon:136.6256  },
  { key:'nikko',       kor:'닛코',       eng:'Nikko',          flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:36.7197,  lon:139.6985  },
  { key:'hakone',      kor:'하코네',     eng:'Hakone',         flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:35.2329,  lon:139.0233  },
  { key:'nagoya',      kor:'나고야',     eng:'Nagoya',         flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:35.1815,  lon:136.9066  },
  { key:'sendai',      kor:'센다이',     eng:'Sendai',         flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:38.2682,  lon:140.8694  },
  { key:'hakodate',    kor:'하코다테',   eng:'Hakodate',       flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:41.7688,  lon:140.7290  },
  { key:'kumamoto',    kor:'구마모토',   eng:'Kumamoto',       flag:'🇯🇵', zone:'Asia/Tokyo',           currency:'JPY', lat:32.8032,  lon:130.7079  },
  // ── 한국 도시 ──
  { key:'jeju',        kor:'제주',       eng:'Jeju',           flag:'🇰🇷', zone:'Asia/Seoul',           currency:'KRW', lat:33.4996,  lon:126.5312  },
  { key:'busan',       kor:'부산',       eng:'Busan',          flag:'🇰🇷', zone:'Asia/Seoul',           currency:'KRW', lat:35.1796,  lon:129.0756  },
  { key:'gyeongju',    kor:'경주',       eng:'Gyeongju',       flag:'🇰🇷', zone:'Asia/Seoul',           currency:'KRW', lat:35.8562,  lon:129.2247  },
  { key:'jeonju',      kor:'전주',       eng:'Jeonju',         flag:'🇰🇷', zone:'Asia/Seoul',           currency:'KRW', lat:35.8242,  lon:127.1480  },
  { key:'gangneung',   kor:'강릉',       eng:'Gangneung',      flag:'🇰🇷', zone:'Asia/Seoul',           currency:'KRW', lat:37.7519,  lon:128.8761  },
  { key:'sokcho',      kor:'속초',       eng:'Sokcho',         flag:'🇰🇷', zone:'Asia/Seoul',           currency:'KRW', lat:38.2070,  lon:128.5918  },
  { key:'yeosu',       kor:'여수',       eng:'Yeosu',          flag:'🇰🇷', zone:'Asia/Seoul',           currency:'KRW', lat:34.7604,  lon:127.6622  },
  { key:'incheon',     kor:'인천',       eng:'Incheon',        flag:'🇰🇷', zone:'Asia/Seoul',           currency:'KRW', lat:37.4563,  lon:126.7052  },
  // ── 이탈리아 도시/지역 ──
  { key:'rome',        kor:'로마',       eng:'Rome',           flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:41.9028,  lon:12.4964   },
  { key:'milan',       kor:'밀라노',     eng:'Milan',          flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:45.4654,  lon:9.1859    },
  { key:'venice',      kor:'베네치아',   eng:'Venice',         flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:45.4408,  lon:12.3155   },
  { key:'florence',    kor:'피렌체',     eng:'Florence',       flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:43.7696,  lon:11.2558   },
  { key:'naples',      kor:'나폴리',     eng:'Naples',         flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:40.8518,  lon:14.2681   },
  { key:'amalfi',      kor:'아말피',     eng:'Amalfi Coast',   flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:40.6340,  lon:14.6026   },
  { key:'cinqueterre', kor:'친퀘테레',   eng:'Cinque Terre',   flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:44.1461,  lon:9.6439    },
  { key:'dolomites',   kor:'돌로미티',   eng:'Dolomites',      flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:46.4102,  lon:11.8440   },
  { key:'sicily',      kor:'시칠리아',   eng:'Sicily',         flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:37.5990,  lon:14.0154   },
  { key:'sardinia',    kor:'사르데냐',   eng:'Sardinia',       flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:40.1209,  lon:9.0129    },
  { key:'tuscany',     kor:'토스카나',   eng:'Tuscany',        flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:43.7711,  lon:11.2486   },
  { key:'verona',      kor:'베로나',     eng:'Verona',         flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:45.4384,  lon:10.9916   },
  { key:'bologna',     kor:'볼로냐',     eng:'Bologna',        flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:44.4949,  lon:11.3426   },
  { key:'turin',       kor:'토리노',     eng:'Turin',          flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:45.0703,  lon:7.6869    },
  { key:'pompeii',     kor:'폼페이',     eng:'Pompeii',        flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:40.7462,  lon:14.4989   },
  { key:'positano',    kor:'포시타노',   eng:'Positano',       flag:'🇮🇹', zone:'Europe/Rome',          currency:'EUR', lat:40.6282,  lon:14.4843   },
  // ── 프랑스 도시/지역 ──
  { key:'paris',       kor:'파리',       eng:'Paris',          flag:'🇫🇷', zone:'Europe/Paris',         currency:'EUR', lat:48.8566,  lon:2.3522    },
  { key:'nice',        kor:'니스',       eng:'Nice',           flag:'🇫🇷', zone:'Europe/Paris',         currency:'EUR', lat:43.7102,  lon:7.2620    },
  { key:'marseille',   kor:'마르세유',   eng:'Marseille',      flag:'🇫🇷', zone:'Europe/Paris',         currency:'EUR', lat:43.2965,  lon:5.3698    },
  { key:'lyon',        kor:'리옹',       eng:'Lyon',           flag:'🇫🇷', zone:'Europe/Paris',         currency:'EUR', lat:45.7640,  lon:4.8357    },
  { key:'bordeaux',    kor:'보르도',     eng:'Bordeaux',       flag:'🇫🇷', zone:'Europe/Paris',         currency:'EUR', lat:44.8378,  lon:-0.5792   },
  { key:'provence',    kor:'프로방스',   eng:'Provence',       flag:'🇫🇷', zone:'Europe/Paris',         currency:'EUR', lat:43.9493,  lon:5.1388    },
  { key:'normandy',    kor:'노르망디',   eng:'Normandy',       flag:'🇫🇷', zone:'Europe/Paris',         currency:'EUR', lat:49.1829,  lon:-0.3707   },
  { key:'strasbourg',  kor:'스트라스부르',eng:'Strasbourg',    flag:'🇫🇷', zone:'Europe/Paris',         currency:'EUR', lat:48.5734,  lon:7.7521    },
  { key:'montsaintmichel',kor:'몽생미셸',eng:'Mont Saint-Michel',flag:'🇫🇷',zone:'Europe/Paris',       currency:'EUR', lat:48.6361,  lon:-1.5115   },
  { key:'chamonix',    kor:'샤모니',     eng:'Chamonix',       flag:'🇫🇷', zone:'Europe/Paris',         currency:'EUR', lat:45.9237,  lon:6.8694    },
  { key:'versailles',  kor:'베르사유',   eng:'Versailles',     flag:'🇫🇷', zone:'Europe/Paris',         currency:'EUR', lat:48.8049,  lon:2.1204    },
  // ── 스페인 도시/지역 ──
  { key:'barcelona',   kor:'바르셀로나', eng:'Barcelona',      flag:'🇪🇸', zone:'Europe/Madrid',        currency:'EUR', lat:41.3851,  lon:2.1734    },
  { key:'madrid',      kor:'마드리드',   eng:'Madrid',         flag:'🇪🇸', zone:'Europe/Madrid',        currency:'EUR', lat:40.4168,  lon:-3.7038   },
  { key:'seville',     kor:'세비야',     eng:'Seville',        flag:'🇪🇸', zone:'Europe/Madrid',        currency:'EUR', lat:37.3891,  lon:-5.9845   },
  { key:'granada',     kor:'그라나다',   eng:'Granada',        flag:'🇪🇸', zone:'Europe/Madrid',        currency:'EUR', lat:37.1773,  lon:-3.5986   },
  { key:'valencia',    kor:'발렌시아',   eng:'Valencia',       flag:'🇪🇸', zone:'Europe/Madrid',        currency:'EUR', lat:39.4699,  lon:-0.3763   },
  { key:'ibiza',       kor:'이비자',     eng:'Ibiza',          flag:'🇪🇸', zone:'Europe/Madrid',        currency:'EUR', lat:38.9067,  lon:1.4206    },
  { key:'mallorca',    kor:'마요르카',   eng:'Mallorca',       flag:'🇪🇸', zone:'Europe/Madrid',        currency:'EUR', lat:39.6953,  lon:3.0176    },
  { key:'sansebastian',kor:'산 세바스티안',eng:'San Sebastián',flag:'🇪🇸', zone:'Europe/Madrid',        currency:'EUR', lat:43.3183,  lon:-1.9812   },
  { key:'bilbao',      kor:'빌바오',     eng:'Bilbao',         flag:'🇪🇸', zone:'Europe/Madrid',        currency:'EUR', lat:43.2630,  lon:-2.9350   },
  { key:'malaga',      kor:'말라가',     eng:'Málaga',         flag:'🇪🇸', zone:'Europe/Madrid',        currency:'EUR', lat:36.7213,  lon:-4.4214   },
  { key:'toledo',      kor:'톨레도',     eng:'Toledo',         flag:'🇪🇸', zone:'Europe/Madrid',        currency:'EUR', lat:39.8628,  lon:-4.0273   },
  { key:'tenerife',    kor:'테네리페',   eng:'Tenerife',       flag:'🇪🇸', zone:'Atlantic/Canary',      currency:'EUR', lat:28.2916,  lon:-16.6291  },
  // ── 그리스 도시/지역 ──
  { key:'athens',      kor:'아테네',     eng:'Athens',         flag:'🇬🇷', zone:'Europe/Athens',        currency:'EUR', lat:37.9838,  lon:23.7275   },
  { key:'santorini',   kor:'산토리니',   eng:'Santorini',      flag:'🇬🇷', zone:'Europe/Athens',        currency:'EUR', lat:36.3932,  lon:25.4615   },
  { key:'mykonos',     kor:'미코노스',   eng:'Mykonos',        flag:'🇬🇷', zone:'Europe/Athens',        currency:'EUR', lat:37.4467,  lon:25.3289   },
  { key:'crete',       kor:'크레타',     eng:'Crete',          flag:'🇬🇷', zone:'Europe/Athens',        currency:'EUR', lat:35.2401,  lon:24.8093   },
  { key:'rhodes',      kor:'로도스',     eng:'Rhodes',         flag:'🇬🇷', zone:'Europe/Athens',        currency:'EUR', lat:36.4341,  lon:28.2176   },
  { key:'corfu',       kor:'코르푸',     eng:'Corfu',          flag:'🇬🇷', zone:'Europe/Athens',        currency:'EUR', lat:39.6243,  lon:19.9217   },
  { key:'zakynthos',   kor:'자킨토스',   eng:'Zakynthos',      flag:'🇬🇷', zone:'Europe/Athens',        currency:'EUR', lat:37.7902,  lon:20.9007   },
  { key:'meteora',     kor:'메테오라',   eng:'Meteora',        flag:'🇬🇷', zone:'Europe/Athens',        currency:'EUR', lat:39.7217,  lon:21.6306   },
  // ── 포르투갈 도시/지역 ──
  { key:'lisbon',      kor:'리스본',     eng:'Lisbon',         flag:'🇵🇹', zone:'Europe/Lisbon',        currency:'EUR', lat:38.7223,  lon:-9.1393   },
  { key:'porto',       kor:'포르투',     eng:'Porto',          flag:'🇵🇹', zone:'Europe/Lisbon',        currency:'EUR', lat:41.1579,  lon:-8.6291   },
  { key:'algarve',     kor:'알가르브',   eng:'Algarve',        flag:'🇵🇹', zone:'Europe/Lisbon',        currency:'EUR', lat:37.0179,  lon:-7.9307   },
  { key:'madeira',     kor:'마데이라',   eng:'Madeira',        flag:'🇵🇹', zone:'Atlantic/Madeira',     currency:'EUR', lat:32.7607,  lon:-16.9595  },
  { key:'azores',      kor:'아조레스',   eng:'Azores',         flag:'🇵🇹', zone:'Atlantic/Azores',      currency:'EUR', lat:37.7412,  lon:-25.6756  },
  { key:'sintra',      kor:'신트라',     eng:'Sintra',         flag:'🇵🇹', zone:'Europe/Lisbon',        currency:'EUR', lat:38.7979,  lon:-9.3881   },
  // ── 독일 도시/지역 ──
  { key:'munich',      kor:'뮌헨',       eng:'Munich',         flag:'🇩🇪', zone:'Europe/Berlin',        currency:'EUR', lat:48.1351,  lon:11.5820   },
  { key:'berlin',      kor:'베를린',     eng:'Berlin',         flag:'🇩🇪', zone:'Europe/Berlin',        currency:'EUR', lat:52.5200,  lon:13.4050   },
  { key:'frankfurt',   kor:'프랑크푸르트',eng:'Frankfurt',     flag:'🇩🇪', zone:'Europe/Berlin',        currency:'EUR', lat:50.1109,  lon:8.6821    },
  { key:'hamburg',     kor:'함부르크',   eng:'Hamburg',        flag:'🇩🇪', zone:'Europe/Berlin',        currency:'EUR', lat:53.5753,  lon:10.0153   },
  { key:'heidelberg',  kor:'하이델베르크',eng:'Heidelberg',    flag:'🇩🇪', zone:'Europe/Berlin',        currency:'EUR', lat:49.3988,  lon:8.6724    },
  { key:'cologne',     kor:'쾰른',       eng:'Cologne',        flag:'🇩🇪', zone:'Europe/Berlin',        currency:'EUR', lat:50.9333,  lon:6.9500    },
  { key:'rothenburg',  kor:'로텐부르크', eng:'Rothenburg',     flag:'🇩🇪', zone:'Europe/Berlin',        currency:'EUR', lat:49.3774,  lon:10.1803   },
  { key:'neuschwanstein',kor:'노이슈반슈타인',eng:'Neuschwanstein',flag:'🇩🇪',zone:'Europe/Berlin',   currency:'EUR', lat:47.5576,  lon:10.7498   },
  { key:'blackforest', kor:'흑림',       eng:'Black Forest',   flag:'🇩🇪', zone:'Europe/Berlin',        currency:'EUR', lat:48.0000,  lon:8.2000    },
  { key:'dresden',     kor:'드레스덴',   eng:'Dresden',        flag:'🇩🇪', zone:'Europe/Berlin',        currency:'EUR', lat:51.0504,  lon:13.7373   },
  { key:'nuremberg',   kor:'뉘른베르크', eng:'Nuremberg',      flag:'🇩🇪', zone:'Europe/Berlin',        currency:'EUR', lat:49.4521,  lon:11.0767   },
  // ── 스위스 도시/지역 ──
  { key:'zurich',      kor:'취리히',     eng:'Zurich',         flag:'🇨🇭', zone:'Europe/Zurich',        currency:'CHF', lat:47.3769,  lon:8.5417    },
  { key:'geneva',      kor:'제네바',     eng:'Geneva',         flag:'🇨🇭', zone:'Europe/Zurich',        currency:'CHF', lat:46.2044,  lon:6.1432    },
  { key:'interlaken',  kor:'인터라켄',   eng:'Interlaken',     flag:'🇨🇭', zone:'Europe/Zurich',        currency:'CHF', lat:46.6863,  lon:7.8632    },
  { key:'lucerne',     kor:'루체른',     eng:'Lucerne',        flag:'🇨🇭', zone:'Europe/Zurich',        currency:'CHF', lat:47.0502,  lon:8.3093    },
  { key:'zermatt',     kor:'체르마트',   eng:'Zermatt',        flag:'🇨🇭', zone:'Europe/Zurich',        currency:'CHF', lat:46.0207,  lon:7.7491    },
  { key:'bern',        kor:'베른',       eng:'Bern',           flag:'🇨🇭', zone:'Europe/Zurich',        currency:'CHF', lat:46.9480,  lon:7.4474    },
  { key:'grindelwald', kor:'그린델발트', eng:'Grindelwald',    flag:'🇨🇭', zone:'Europe/Zurich',        currency:'CHF', lat:46.6244,  lon:8.0411    },
  // ── 오스트리아 도시/지역 ──
  { key:'vienna',      kor:'비엔나',     eng:'Vienna',         flag:'🇦🇹', zone:'Europe/Vienna',        currency:'EUR', lat:48.2082,  lon:16.3738   },
  { key:'salzburg',    kor:'잘츠부르크', eng:'Salzburg',       flag:'🇦🇹', zone:'Europe/Vienna',        currency:'EUR', lat:47.8095,  lon:13.0550   },
  { key:'innsbruck',   kor:'인스브루크', eng:'Innsbruck',      flag:'🇦🇹', zone:'Europe/Vienna',        currency:'EUR', lat:47.2682,  lon:11.3923   },
  { key:'hallstatt',   kor:'할슈타트',   eng:'Hallstatt',      flag:'🇦🇹', zone:'Europe/Vienna',        currency:'EUR', lat:47.5622,  lon:13.6493   },
  // ── 크로아티아 도시/지역 ──
  { key:'dubrovnik',   kor:'두브로브니크',eng:'Dubrovnik',     flag:'🇭🇷', zone:'Europe/Zagreb',        currency:'EUR', lat:42.6507,  lon:18.0944   },
  { key:'split',       kor:'스플리트',   eng:'Split',          flag:'🇭🇷', zone:'Europe/Zagreb',        currency:'EUR', lat:43.5081,  lon:16.4402   },
  { key:'plitvice',    kor:'플리트비체', eng:'Plitvice Lakes', flag:'🇭🇷', zone:'Europe/Zagreb',        currency:'EUR', lat:44.8804,  lon:15.6168   },
  { key:'hvar',        kor:'흐바르',     eng:'Hvar',           flag:'🇭🇷', zone:'Europe/Zagreb',        currency:'EUR', lat:43.1729,  lon:16.4412   },
  // ── 체코 ──
  { key:'prague',      kor:'프라하',     eng:'Prague',         flag:'🇨🇿', zone:'Europe/Prague',        currency:'CZK', lat:50.0755,  lon:14.4378   },
  { key:'ceskykrumlov',kor:'체스키크룸로프',eng:'Český Krumlov',flag:'🇨🇿',zone:'Europe/Prague',       currency:'CZK', lat:48.8127,  lon:14.3175   },
  // ── 헝가리 ──
  { key:'budapest',    kor:'부다페스트', eng:'Budapest',       flag:'🇭🇺', zone:'Europe/Budapest',      currency:'HUF', lat:47.4979,  lon:19.0402   },
  // ── 폴란드 ──
  { key:'warsaw',      kor:'바르샤바',   eng:'Warsaw',         flag:'🇵🇱', zone:'Europe/Warsaw',        currency:'PLN', lat:52.2297,  lon:21.0122   },
  { key:'krakow',      kor:'크라쿠프',   eng:'Kraków',         flag:'🇵🇱', zone:'Europe/Warsaw',        currency:'PLN', lat:50.0647,  lon:19.9450   },
  // ── 영국 도시/지역 ──
  { key:'london',      kor:'런던',       eng:'London',         flag:'🇬🇧', zone:'Europe/London',        currency:'GBP', lat:51.5074,  lon:-0.1278   },
  { key:'edinburgh',   kor:'에든버러',   eng:'Edinburgh',      flag:'🇬🇧', zone:'Europe/London',        currency:'GBP', lat:55.9533,  lon:-3.1883   },
  { key:'cotswolds',   kor:'코츠월즈',   eng:'Cotswolds',      flag:'🇬🇧', zone:'Europe/London',        currency:'GBP', lat:51.8330,  lon:-1.8433   },
  { key:'oxford',      kor:'옥스퍼드',   eng:'Oxford',         flag:'🇬🇧', zone:'Europe/London',        currency:'GBP', lat:51.7520,  lon:-1.2577   },
  { key:'bath',        kor:'바스',       eng:'Bath',           flag:'🇬🇧', zone:'Europe/London',        currency:'GBP', lat:51.3811,  lon:-2.3590   },
  { key:'scottishhighlands',kor:'스코틀랜드 하이랜드',eng:'Scottish Highlands',flag:'🇬🇧',zone:'Europe/London',currency:'GBP',lat:57.1200,lon:-4.7200},
  { key:'cambridge',   kor:'케임브리지', eng:'Cambridge',      flag:'🇬🇧', zone:'Europe/London',        currency:'GBP', lat:52.2053,  lon:0.1218    },
  // ── 노르웨이 도시/지역 ──
  { key:'oslo',        kor:'오슬로',     eng:'Oslo',           flag:'🇳🇴', zone:'Europe/Oslo',          currency:'NOK', lat:59.9139,  lon:10.7522   },
  { key:'bergen',      kor:'베르겐',     eng:'Bergen',         flag:'🇳🇴', zone:'Europe/Oslo',          currency:'NOK', lat:60.3913,  lon:5.3221    },
  { key:'fjords',      kor:'피요르드',   eng:'Norwegian Fjords',flag:'🇳🇴',zone:'Europe/Oslo',          currency:'NOK', lat:61.0000,  lon:7.0000    },
  { key:'tromso',      kor:'트롬쇠',     eng:'Tromsø',         flag:'🇳🇴', zone:'Europe/Oslo',          currency:'NOK', lat:69.6496,  lon:18.9560   },
  { key:'lofoten',     kor:'로포텐',     eng:'Lofoten',        flag:'🇳🇴', zone:'Europe/Oslo',          currency:'NOK', lat:68.1984,  lon:13.5860   },
  // ── 스웨덴 ──
  { key:'stockholm',   kor:'스톡홀름',   eng:'Stockholm',      flag:'🇸🇪', zone:'Europe/Stockholm',     currency:'SEK', lat:59.3293,  lon:18.0686   },
  { key:'gothenburg',  kor:'예테보리',   eng:'Gothenburg',     flag:'🇸🇪', zone:'Europe/Stockholm',     currency:'SEK', lat:57.7089,  lon:11.9746   },
  // ── 핀란드 ──
  { key:'helsinki',    kor:'헬싱키',     eng:'Helsinki',       flag:'🇫🇮', zone:'Europe/Helsinki',      currency:'EUR', lat:60.1699,  lon:24.9384   },
  { key:'rovaniemi',   kor:'로바니에미', eng:'Rovaniemi',      flag:'🇫🇮', zone:'Europe/Helsinki',      currency:'EUR', lat:66.5039,  lon:25.7294   },
  // ── 덴마크 ──
  { key:'copenhagen',  kor:'코펜하겐',   eng:'Copenhagen',     flag:'🇩🇰', zone:'Europe/Copenhagen',    currency:'DKK', lat:55.6761,  lon:12.5683   },
  // ── 아이슬란드 ──
  { key:'reykjavik',   kor:'레이캬비크', eng:'Reykjavik',      flag:'🇮🇸', zone:'Atlantic/Reykjavik',   currency:'ISK', lat:64.1265,  lon:-21.8174  },
  { key:'goldencircle',kor:'골든서클',   eng:'Golden Circle',  flag:'🇮🇸', zone:'Atlantic/Reykjavik',   currency:'ISK', lat:64.3271,  lon:-20.1199  },
  // ── 터키 도시 ──
  { key:'istanbul',    kor:'이스탄불',   eng:'Istanbul',       flag:'🇹🇷', zone:'Europe/Istanbul',      currency:'TRY', lat:41.0082,  lon:28.9784   },
  { key:'cappadocia',  kor:'카파도키아', eng:'Cappadocia',     flag:'🇹🇷', zone:'Europe/Istanbul',      currency:'TRY', lat:38.6431,  lon:34.8289   },
  { key:'antalya',     kor:'안탈리아',   eng:'Antalya',        flag:'🇹🇷', zone:'Europe/Istanbul',      currency:'TRY', lat:36.8969,  lon:30.7133   },
  { key:'pamukkale',   kor:'파묵칼레',   eng:'Pamukkale',      flag:'🇹🇷', zone:'Europe/Istanbul',      currency:'TRY', lat:37.9140,  lon:29.1200   },
  { key:'bodrum',      kor:'보드룸',     eng:'Bodrum',         flag:'🇹🇷', zone:'Europe/Istanbul',      currency:'TRY', lat:37.0344,  lon:27.4305   },
  // ── 태국 도시 ──
  { key:'bangkok',     kor:'방콕',       eng:'Bangkok',        flag:'🇹🇭', zone:'Asia/Bangkok',         currency:'THB', lat:13.7563,  lon:100.5018  },
  { key:'chiangmai',   kor:'치앙마이',   eng:'Chiang Mai',     flag:'🇹🇭', zone:'Asia/Bangkok',         currency:'THB', lat:18.7883,  lon:98.9853   },
  { key:'phuket',      kor:'푸켓',       eng:'Phuket',         flag:'🇹🇭', zone:'Asia/Bangkok',         currency:'THB', lat:7.8804,   lon:98.3923   },
  { key:'kohsamui',    kor:'코사무이',   eng:'Koh Samui',      flag:'🇹🇭', zone:'Asia/Bangkok',         currency:'THB', lat:9.5120,   lon:100.0136  },
  { key:'krabi',       kor:'끄라비',     eng:'Krabi',          flag:'🇹🇭', zone:'Asia/Bangkok',         currency:'THB', lat:8.0863,   lon:98.9063   },
  { key:'pattaya',     kor:'파타야',     eng:'Pattaya',        flag:'🇹🇭', zone:'Asia/Bangkok',         currency:'THB', lat:12.9236,  lon:100.8825  },
  { key:'ayutthaya',   kor:'아유타야',   eng:'Ayutthaya',      flag:'🇹🇭', zone:'Asia/Bangkok',         currency:'THB', lat:14.3532,  lon:100.5673  },
  { key:'chiangrai',   kor:'치앙라이',   eng:'Chiang Rai',     flag:'🇹🇭', zone:'Asia/Bangkok',         currency:'THB', lat:19.9071,  lon:99.8305   },
  { key:'kohpiphi',    kor:'코피피',     eng:'Koh Phi Phi',    flag:'🇹🇭', zone:'Asia/Bangkok',         currency:'THB', lat:7.7407,   lon:98.7784   },
  { key:'huahin',      kor:'후아힌',     eng:'Hua Hin',        flag:'🇹🇭', zone:'Asia/Bangkok',         currency:'THB', lat:12.5681,  lon:99.9584   },
  // ── 베트남 도시 ──
  { key:'hanoi',       kor:'하노이',     eng:'Hanoi',          flag:'🇻🇳', zone:'Asia/Ho_Chi_Minh',     currency:'VND', lat:21.0285,  lon:105.8542  },
  { key:'hochiminh',   kor:'호치민',     eng:'Ho Chi Minh City',flag:'🇻🇳',zone:'Asia/Ho_Chi_Minh',    currency:'VND', lat:10.8231,  lon:106.6297  },
  { key:'danang',      kor:'다낭',       eng:'Da Nang',        flag:'🇻🇳', zone:'Asia/Ho_Chi_Minh',     currency:'VND', lat:16.0544,  lon:108.2022  },
  { key:'hoian',       kor:'호이안',     eng:'Hoi An',         flag:'🇻🇳', zone:'Asia/Ho_Chi_Minh',     currency:'VND', lat:15.8801,  lon:108.3380  },
  { key:'halong',      kor:'하롱베이',   eng:'Ha Long Bay',    flag:'🇻🇳', zone:'Asia/Ho_Chi_Minh',     currency:'VND', lat:20.9101,  lon:107.1839  },
  { key:'dalat',       kor:'달랏',       eng:'Da Lat',         flag:'🇻🇳', zone:'Asia/Ho_Chi_Minh',     currency:'VND', lat:11.9404,  lon:108.4584  },
  { key:'nhatrang',    kor:'냐짱',       eng:'Nha Trang',      flag:'🇻🇳', zone:'Asia/Ho_Chi_Minh',     currency:'VND', lat:12.2388,  lon:109.1967  },
  { key:'phuquoc',     kor:'푸꾸옥',     eng:'Phu Quoc',       flag:'🇻🇳', zone:'Asia/Ho_Chi_Minh',     currency:'VND', lat:10.2899,  lon:103.9840  },
  { key:'hue',         kor:'후에',       eng:'Hue',            flag:'🇻🇳', zone:'Asia/Ho_Chi_Minh',     currency:'VND', lat:16.4637,  lon:107.5909  },
  // ── 인도네시아 ──
  { key:'bali',        kor:'발리',       eng:'Bali',           flag:'🇮🇩', zone:'Asia/Makassar',        currency:'IDR', lat:-8.3405,  lon:115.0920  },
  { key:'ubud',        kor:'우붓',       eng:'Ubud',           flag:'🇮🇩', zone:'Asia/Makassar',        currency:'IDR', lat:-8.5069,  lon:115.2625  },
  { key:'lombok',      kor:'롬복',       eng:'Lombok',         flag:'🇮🇩', zone:'Asia/Makassar',        currency:'IDR', lat:-8.6500,  lon:116.3248  },
  { key:'yogyakarta',  kor:'족자카르타', eng:'Yogyakarta',     flag:'🇮🇩', zone:'Asia/Jakarta',         currency:'IDR', lat:-7.7956,  lon:110.3695  },
  { key:'jakarta',     kor:'자카르타',   eng:'Jakarta',        flag:'🇮🇩', zone:'Asia/Jakarta',         currency:'IDR', lat:-6.2088,  lon:106.8456  },
  { key:'komodo',      kor:'코모도',     eng:'Komodo',         flag:'🇮🇩', zone:'Asia/Makassar',        currency:'IDR', lat:-8.5486,  lon:119.4875  },
  { key:'rajaampat',   kor:'라자암팟',   eng:'Raja Ampat',     flag:'🇮🇩', zone:'Asia/Jayapura',        currency:'IDR', lat:-0.5000,  lon:130.1000  },
  { key:'labuanbajo',  kor:'라부안바조', eng:'Labuan Bajo',    flag:'🇮🇩', zone:'Asia/Makassar',        currency:'IDR', lat:-8.4962,  lon:119.8872  },
  { key:'giliislands', kor:'길리섬',     eng:'Gili Islands',   flag:'🇮🇩', zone:'Asia/Makassar',        currency:'IDR', lat:-8.3553,  lon:116.0441  },
  // ── 필리핀 ──
  { key:'manila',      kor:'마닐라',     eng:'Manila',         flag:'🇵🇭', zone:'Asia/Manila',          currency:'PHP', lat:14.5995,  lon:120.9842  },
  { key:'cebu',        kor:'세부',       eng:'Cebu',           flag:'🇵🇭', zone:'Asia/Manila',          currency:'PHP', lat:10.3157,  lon:123.8854  },
  { key:'palawan',     kor:'팔라완',     eng:'Palawan',        flag:'🇵🇭', zone:'Asia/Manila',          currency:'PHP', lat:9.8349,   lon:118.7384  },
  { key:'boracay',     kor:'보라카이',   eng:'Boracay',        flag:'🇵🇭', zone:'Asia/Manila',          currency:'PHP', lat:11.9674,  lon:121.9248  },
  { key:'siargao',     kor:'시아르가오', eng:'Siargao',        flag:'🇵🇭', zone:'Asia/Manila',          currency:'PHP', lat:9.8483,   lon:126.0458  },
  { key:'elnido',      kor:'엘니도',     eng:'El Nido',        flag:'🇵🇭', zone:'Asia/Manila',          currency:'PHP', lat:11.1750,  lon:119.4019  },
  // ── 말레이시아 ──
  { key:'kualalumpur', kor:'쿠알라룸푸르',eng:'Kuala Lumpur',  flag:'🇲🇾', zone:'Asia/Kuala_Lumpur',    currency:'MYR', lat:3.1390,   lon:101.6869  },
  { key:'penang',      kor:'페낭',       eng:'Penang',         flag:'🇲🇾', zone:'Asia/Kuala_Lumpur',    currency:'MYR', lat:5.4164,   lon:100.3327  },
  { key:'kotakinabalu',kor:'코타키나발루',eng:'Kota Kinabalu', flag:'🇲🇾', zone:'Asia/Kuching',         currency:'MYR', lat:5.9788,   lon:116.0753  },
  { key:'langkawi',    kor:'랑카위',     eng:'Langkawi',       flag:'🇲🇾', zone:'Asia/Kuala_Lumpur',    currency:'MYR', lat:6.3500,   lon:99.8000   },
  { key:'malacca',     kor:'말라카',     eng:'Malacca',        flag:'🇲🇾', zone:'Asia/Kuala_Lumpur',    currency:'MYR', lat:2.1896,   lon:102.2501  },
  // ── 캄보디아 ──
  { key:'siemreap',    kor:'씨엠립',     eng:'Siem Reap',      flag:'🇰🇭', zone:'Asia/Phnom_Penh',      currency:'KHR', lat:13.3671,  lon:103.8448  },
  { key:'angkorwat',   kor:'앙코르와트', eng:'Angkor Wat',     flag:'🇰🇭', zone:'Asia/Phnom_Penh',      currency:'KHR', lat:13.4125,  lon:103.8670  },
  { key:'phnompenh',   kor:'프놈펜',     eng:'Phnom Penh',     flag:'🇰🇭', zone:'Asia/Phnom_Penh',      currency:'KHR', lat:11.5564,  lon:104.9282  },
  // ── 라오스 ──
  { key:'luangprabang',kor:'루앙프라방', eng:'Luang Prabang',  flag:'🇱🇦', zone:'Asia/Vientiane',       currency:'LAK', lat:19.8844,  lon:102.1347  },
  { key:'vangvieng',   kor:'방비엥',     eng:'Vang Vieng',     flag:'🇱🇦', zone:'Asia/Vientiane',       currency:'LAK', lat:18.9215,  lon:102.4439  },
  // ── 미얀마 ──
  { key:'yangon',      kor:'양곤',       eng:'Yangon',         flag:'🇲🇲', zone:'Asia/Rangoon',         currency:'MMK', lat:16.8661,  lon:96.1951   },
  { key:'bagan',       kor:'바간',       eng:'Bagan',          flag:'🇲🇲', zone:'Asia/Rangoon',         currency:'MMK', lat:21.1717,  lon:94.8585   },
  { key:'mandalay',    kor:'만달레이',   eng:'Mandalay',       flag:'🇲🇲', zone:'Asia/Rangoon',         currency:'MMK', lat:21.9588,  lon:96.0891   },
  { key:'inlelake',    kor:'인레호수',   eng:'Inle Lake',      flag:'🇲🇲', zone:'Asia/Rangoon',         currency:'MMK', lat:20.5195,  lon:96.9007   },
  // ── 대만 도시 ──
  { key:'taipei',      kor:'타이베이',   eng:'Taipei',         flag:'🇹🇼', zone:'Asia/Taipei',          currency:'TWD', lat:25.0330,  lon:121.5654  },
  { key:'jiufen',      kor:'지우펀',     eng:'Jiufen',         flag:'🇹🇼', zone:'Asia/Taipei',          currency:'TWD', lat:25.1092,  lon:121.8442  },
  { key:'taroko',      kor:'타로코',     eng:'Taroko Gorge',   flag:'🇹🇼', zone:'Asia/Taipei',          currency:'TWD', lat:24.1575,  lon:121.6295  },
  { key:'tainan',      kor:'타이난',     eng:'Tainan',         flag:'🇹🇼', zone:'Asia/Taipei',          currency:'TWD', lat:22.9999,  lon:120.2270  },
  // ── 인도 도시 ──
  { key:'delhi',       kor:'델리',       eng:'Delhi',          flag:'🇮🇳', zone:'Asia/Kolkata',         currency:'INR', lat:28.7041,  lon:77.1025   },
  { key:'mumbai',      kor:'뭄바이',     eng:'Mumbai',         flag:'🇮🇳', zone:'Asia/Kolkata',         currency:'INR', lat:19.0760,  lon:72.8777   },
  { key:'agra',        kor:'아그라',     eng:'Agra',           flag:'🇮🇳', zone:'Asia/Kolkata',         currency:'INR', lat:27.1767,  lon:78.0081   },
  { key:'jaipur',      kor:'자이푸르',   eng:'Jaipur',         flag:'🇮🇳', zone:'Asia/Kolkata',         currency:'INR', lat:26.9124,  lon:75.7873   },
  { key:'varanasi',    kor:'바라나시',   eng:'Varanasi',       flag:'🇮🇳', zone:'Asia/Kolkata',         currency:'INR', lat:25.3176,  lon:82.9739   },
  { key:'goa',         kor:'고아',       eng:'Goa',            flag:'🇮🇳', zone:'Asia/Kolkata',         currency:'INR', lat:15.2993,  lon:74.1240   },
  { key:'kerala',      kor:'케랄라',     eng:'Kerala',         flag:'🇮🇳', zone:'Asia/Kolkata',         currency:'INR', lat:10.8505,  lon:76.2711   },
  // ── 중국 도시 ──
  { key:'beijing',     kor:'베이징',     eng:'Beijing',        flag:'🇨🇳', zone:'Asia/Shanghai',        currency:'CNY', lat:39.9042,  lon:116.4074  },
  { key:'shanghai',    kor:'상하이',     eng:'Shanghai',       flag:'🇨🇳', zone:'Asia/Shanghai',        currency:'CNY', lat:31.2304,  lon:121.4737  },
  { key:'xian',        kor:'시안',       eng:"Xi'an",          flag:'🇨🇳', zone:'Asia/Shanghai',        currency:'CNY', lat:34.3416,  lon:108.9398  },
  { key:'guilin',      kor:'구이린',     eng:'Guilin',         flag:'🇨🇳', zone:'Asia/Shanghai',        currency:'CNY', lat:25.2744,  lon:110.2900  },
  { key:'zhangjiajie', kor:'장자계',     eng:'Zhangjiajie',    flag:'🇨🇳', zone:'Asia/Shanghai',        currency:'CNY', lat:29.1170,  lon:110.4792  },
  { key:'chengdu',     kor:'청두',       eng:'Chengdu',        flag:'🇨🇳', zone:'Asia/Shanghai',        currency:'CNY', lat:30.5728,  lon:104.0668  },
  { key:'yunnan',      kor:'윈난',       eng:'Yunnan',         flag:'🇨🇳', zone:'Asia/Shanghai',        currency:'CNY', lat:24.8798,  lon:102.8329  },
  // ── 네팔 ──
  { key:'kathmandu',   kor:'카트만두',   eng:'Kathmandu',      flag:'🇳🇵', zone:'Asia/Kathmandu',       currency:'NPR', lat:27.7172,  lon:85.3240   },
  { key:'pokhara',     kor:'포카라',     eng:'Pokhara',        flag:'🇳🇵', zone:'Asia/Kathmandu',       currency:'NPR', lat:28.2096,  lon:83.9856   },
  { key:'everest',     kor:'에베레스트', eng:'Everest Base Camp',flag:'🇳🇵',zone:'Asia/Kathmandu',      currency:'NPR', lat:28.0025,  lon:86.8528   },
  // ── 스리랑카 ──
  { key:'colombo',     kor:'콜롬보',     eng:'Colombo',        flag:'🇱🇰', zone:'Asia/Colombo',         currency:'LKR', lat:6.9271,   lon:79.8612   },
  { key:'kandy',       kor:'캔디',       eng:'Kandy',          flag:'🇱🇰', zone:'Asia/Colombo',         currency:'LKR', lat:7.2906,   lon:80.6337   },
  { key:'sigiriya',    kor:'시기리야',   eng:'Sigiriya',       flag:'🇱🇰', zone:'Asia/Colombo',         currency:'LKR', lat:7.9570,   lon:80.7603   },
  // ── 몽골 ──
  { key:'ulaanbaatar', kor:'울란바토르', eng:'Ulaanbaatar',    flag:'🇲🇳', zone:'Asia/Ulaanbaatar',     currency:'MNT', lat:47.8864,  lon:106.9057  },
  { key:'gobi',        kor:'고비사막',   eng:'Gobi Desert',    flag:'🇲🇳', zone:'Asia/Ulaanbaatar',     currency:'MNT', lat:43.0000,  lon:106.0000  },
  // ── 조지아 ──
  { key:'tbilisi',     kor:'트빌리시',   eng:'Tbilisi',        flag:'🇬🇪', zone:'Asia/Tbilisi',         currency:'GEL', lat:41.7151,  lon:44.8271   },
  // ── 우즈베키스탄 ──
  { key:'samarkand',   kor:'사마르칸트', eng:'Samarkand',      flag:'🇺🇿', zone:'Asia/Tashkent',        currency:'UZS', lat:39.6270,  lon:66.9750   },
  { key:'bukhara',     kor:'부하라',     eng:'Bukhara',        flag:'🇺🇿', zone:'Asia/Tashkent',        currency:'UZS', lat:39.7680,  lon:64.4556   },
  // ── 러시아 ──
  { key:'moscow',      kor:'모스크바',   eng:'Moscow',         flag:'🇷🇺', zone:'Europe/Moscow',        currency:'RUB', lat:55.7558,  lon:37.6173   },
  { key:'stpetersburg',kor:'상트페테르부르크',eng:'St. Petersburg',flag:'🇷🇺',zone:'Europe/Moscow',    currency:'RUB', lat:59.9311,  lon:30.3609   },
  // ── UAE 도시 ──
  { key:'dubai',       kor:'두바이',     eng:'Dubai',          flag:'🇦🇪', zone:'Asia/Dubai',           currency:'AED', lat:25.2048,  lon:55.2708   },
  { key:'abudhabi',    kor:'아부다비',   eng:'Abu Dhabi',      flag:'🇦🇪', zone:'Asia/Dubai',           currency:'AED', lat:24.4539,  lon:54.3773   },
  // ── 이스라엘 ──
  { key:'jerusalem',   kor:'예루살렘',   eng:'Jerusalem',      flag:'🇮🇱', zone:'Asia/Jerusalem',       currency:'ILS', lat:31.7683,  lon:35.2137   },
  { key:'telaviv',     kor:'텔아비브',   eng:'Tel Aviv',       flag:'🇮🇱', zone:'Asia/Jerusalem',       currency:'ILS', lat:32.0853,  lon:34.7818   },
  // ── 요르단 ──
  { key:'petra',       kor:'페트라',     eng:'Petra',          flag:'🇯🇴', zone:'Asia/Amman',           currency:'JOD', lat:30.3285,  lon:35.4444   },
  { key:'wadirum',     kor:'와디럼',     eng:'Wadi Rum',       flag:'🇯🇴', zone:'Asia/Amman',           currency:'JOD', lat:29.5760,  lon:35.4179   },
  { key:'amman',       kor:'암만',       eng:'Amman',          flag:'🇯🇴', zone:'Asia/Amman',           currency:'JOD', lat:31.9539,  lon:35.9106   },
  // ── 이집트 도시 ──
  { key:'cairo',       kor:'카이로',     eng:'Cairo',          flag:'🇪🇬', zone:'Africa/Cairo',         currency:'EGP', lat:30.0444,  lon:31.2357   },
  { key:'luxor',       kor:'룩소르',     eng:'Luxor',          flag:'🇪🇬', zone:'Africa/Cairo',         currency:'EGP', lat:25.6872,  lon:32.6396   },
  { key:'sharm',       kor:'샤름엘셰이크',eng:'Sharm el-Sheikh',flag:'🇪🇬',zone:'Africa/Cairo',        currency:'EGP', lat:27.9158,  lon:34.3300   },
  { key:'hurghada',    kor:'후르가다',   eng:'Hurghada',       flag:'🇪🇬', zone:'Africa/Cairo',         currency:'EGP', lat:27.2579,  lon:33.8116   },
  // ── 모로코 도시 ──
  { key:'marrakech',   kor:'마라케시',   eng:'Marrakech',      flag:'🇲🇦', zone:'Africa/Casablanca',    currency:'MAD', lat:31.6295,  lon:-7.9811   },
  { key:'fes',         kor:'페스',       eng:'Fes',            flag:'🇲🇦', zone:'Africa/Casablanca',    currency:'MAD', lat:34.0181,  lon:-5.0078   },
  { key:'casablanca',  kor:'카사블랑카', eng:'Casablanca',     flag:'🇲🇦', zone:'Africa/Casablanca',    currency:'MAD', lat:33.5731,  lon:-7.5898   },
  { key:'chefchaouen', kor:'셰프샤우엔', eng:'Chefchaouen',    flag:'🇲🇦', zone:'Africa/Casablanca',    currency:'MAD', lat:35.1688,  lon:-5.2636   },
  // ── 남아프리카 ──
  { key:'capetown',    kor:'케이프타운', eng:'Cape Town',      flag:'🇿🇦', zone:'Africa/Johannesburg',  currency:'ZAR', lat:-33.9249, lon:18.4241   },
  { key:'kruger',      kor:'크루거',     eng:'Kruger National Park',flag:'🇿🇦',zone:'Africa/Johannesburg',currency:'ZAR',lat:-24.0000,lon:31.5000  },
  // ── 케냐 ──
  { key:'nairobi',     kor:'나이로비',   eng:'Nairobi',        flag:'🇰🇪', zone:'Africa/Nairobi',       currency:'KES', lat:-1.2921,  lon:36.8219   },
  { key:'masaimara',   kor:'마사이마라', eng:'Masai Mara',     flag:'🇰🇪', zone:'Africa/Nairobi',       currency:'KES', lat:-1.4853,  lon:35.1056   },
  // ── 탄자니아 ──
  { key:'serengeti',   kor:'세렝게티',   eng:'Serengeti',      flag:'🇹🇿', zone:'Africa/Dar_es_Salaam', currency:'TZS', lat:-2.1540,  lon:34.6857   },
  { key:'kilimanjaro', kor:'킬리만자로', eng:'Kilimanjaro',    flag:'🇹🇿', zone:'Africa/Dar_es_Salaam', currency:'TZS', lat:-3.0674,  lon:37.3556   },
  { key:'zanzibar',    kor:'잔지바르',   eng:'Zanzibar',       flag:'🇹🇿', zone:'Africa/Dar_es_Salaam', currency:'TZS', lat:-6.1659,  lon:39.2026   },
  // ── 미국 도시/지역 ──
  { key:'newyork',     kor:'뉴욕',       eng:'New York',       flag:'🇺🇸', zone:'America/New_York',     currency:'USD', lat:40.7128,  lon:-74.0060  },
  { key:'losangeles',  kor:'로스앤젤레스',eng:'Los Angeles',   flag:'🇺🇸', zone:'America/Los_Angeles',  currency:'USD', lat:34.0522,  lon:-118.2437 },
  { key:'sanfrancisco',kor:'샌프란시스코',eng:'San Francisco', flag:'🇺🇸', zone:'America/Los_Angeles',  currency:'USD', lat:37.7749,  lon:-122.4194 },
  { key:'lasvegas',    kor:'라스베이거스',eng:'Las Vegas',     flag:'🇺🇸', zone:'America/Los_Angeles',  currency:'USD', lat:36.1699,  lon:-115.1398 },
  { key:'miami',       kor:'마이애미',   eng:'Miami',          flag:'🇺🇸', zone:'America/New_York',     currency:'USD', lat:25.7617,  lon:-80.1918  },
  { key:'chicago',     kor:'시카고',     eng:'Chicago',        flag:'🇺🇸', zone:'America/Chicago',      currency:'USD', lat:41.8781,  lon:-87.6298  },
  { key:'seattle',     kor:'시애틀',     eng:'Seattle',        flag:'🇺🇸', zone:'America/Los_Angeles',  currency:'USD', lat:47.6062,  lon:-122.3321 },
  { key:'boston',      kor:'보스턴',     eng:'Boston',         flag:'🇺🇸', zone:'America/New_York',     currency:'USD', lat:42.3601,  lon:-71.0589  },
  { key:'washington',  kor:'워싱턴 DC',  eng:'Washington DC',  flag:'🇺🇸', zone:'America/New_York',     currency:'USD', lat:38.9072,  lon:-77.0369  },
  { key:'grandcanyon', kor:'그랜드캐니언',eng:'Grand Canyon',  flag:'🇺🇸', zone:'America/Phoenix',      currency:'USD', lat:36.1069,  lon:-112.1129 },
  { key:'yellowstone', kor:'옐로스톤',   eng:'Yellowstone',    flag:'🇺🇸', zone:'America/Denver',       currency:'USD', lat:44.4280,  lon:-110.5885 },
  { key:'yosemite',    kor:'요세미티',   eng:'Yosemite',       flag:'🇺🇸', zone:'America/Los_Angeles',  currency:'USD', lat:37.8651,  lon:-119.5383 },
  { key:'neworleans',  kor:'뉴올리언스', eng:'New Orleans',    flag:'🇺🇸', zone:'America/Chicago',      currency:'USD', lat:29.9511,  lon:-90.0715  },
  { key:'alaska',      kor:'알래스카',   eng:'Alaska',         flag:'🇺🇸', zone:'America/Anchorage',    currency:'USD', lat:64.2008,  lon:-153.4937 },
  { key:'portland',    kor:'포틀랜드',   eng:'Portland',       flag:'🇺🇸', zone:'America/Los_Angeles',  currency:'USD', lat:45.5051,  lon:-122.6750 },
  { key:'sandiego',    kor:'샌디에이고', eng:'San Diego',      flag:'🇺🇸', zone:'America/Los_Angeles',  currency:'USD', lat:32.7157,  lon:-117.1611 },
  { key:'nashville',   kor:'내슈빌',     eng:'Nashville',      flag:'🇺🇸', zone:'America/Chicago',      currency:'USD', lat:36.1627,  lon:-86.7816  },
  // ── 캐나다 도시/지역 ──
  { key:'vancouver',   kor:'밴쿠버',     eng:'Vancouver',      flag:'🇨🇦', zone:'America/Vancouver',    currency:'CAD', lat:49.2827,  lon:-123.1207 },
  { key:'toronto',     kor:'토론토',     eng:'Toronto',        flag:'🇨🇦', zone:'America/Toronto',      currency:'CAD', lat:43.6532,  lon:-79.3832  },
  { key:'banff',       kor:'밴프',       eng:'Banff',          flag:'🇨🇦', zone:'America/Edmonton',     currency:'CAD', lat:51.1784,  lon:-115.5708 },
  { key:'quebec',      kor:'퀘벡',       eng:'Québec City',    flag:'🇨🇦', zone:'America/Toronto',      currency:'CAD', lat:46.8139,  lon:-71.2080  },
  { key:'montreal',    kor:'몬트리올',   eng:'Montréal',       flag:'🇨🇦', zone:'America/Toronto',      currency:'CAD', lat:45.5017,  lon:-73.5673  },
  { key:'niagara',     kor:'나이아가라', eng:'Niagara Falls',  flag:'🇨🇦', zone:'America/Toronto',      currency:'CAD', lat:43.0896,  lon:-79.0849  },
  // ── 호주 도시/지역 ──
  { key:'sydney',      kor:'시드니',     eng:'Sydney',         flag:'🇦🇺', zone:'Australia/Sydney',     currency:'AUD', lat:-33.8688, lon:151.2093  },
  { key:'melbourne',   kor:'멜버른',     eng:'Melbourne',      flag:'🇦🇺', zone:'Australia/Melbourne',  currency:'AUD', lat:-37.8136, lon:144.9631  },
  { key:'brisbane',    kor:'브리즈번',   eng:'Brisbane',       flag:'🇦🇺', zone:'Australia/Brisbane',   currency:'AUD', lat:-27.4698, lon:153.0251  },
  { key:'goldcoast',   kor:'골드코스트', eng:'Gold Coast',     flag:'🇦🇺', zone:'Australia/Brisbane',   currency:'AUD', lat:-28.0167, lon:153.4000  },
  { key:'cairns',      kor:'케언즈',     eng:'Cairns',         flag:'🇦🇺', zone:'Australia/Brisbane',   currency:'AUD', lat:-16.9186, lon:145.7781  },
  { key:'uluru',       kor:'울루루',     eng:'Uluru',          flag:'🇦🇺', zone:'Australia/Darwin',     currency:'AUD', lat:-25.3444, lon:131.0369  },
  { key:'perth',       kor:'퍼스',       eng:'Perth',          flag:'🇦🇺', zone:'Australia/Perth',      currency:'AUD', lat:-31.9505, lon:115.8605  },
  // ── 뉴질랜드 도시/지역 ──
  { key:'auckland',    kor:'오클랜드',   eng:'Auckland',       flag:'🇳🇿', zone:'Pacific/Auckland',     currency:'NZD', lat:-36.8509, lon:174.7645  },
  { key:'queenstown',  kor:'퀸스타운',   eng:'Queenstown',     flag:'🇳🇿', zone:'Pacific/Auckland',     currency:'NZD', lat:-45.0312, lon:168.6626  },
  { key:'christchurch',kor:'크라이스트처치',eng:'Christchurch',flag:'🇳🇿',zone:'Pacific/Auckland',     currency:'NZD', lat:-43.5321, lon:172.6362  },
  { key:'rotorua',     kor:'로토루아',   eng:'Rotorua',        flag:'🇳🇿', zone:'Pacific/Auckland',     currency:'NZD', lat:-38.1368, lon:176.2497  },
  { key:'milfordsound',kor:'밀포드사운드',eng:'Milford Sound', flag:'🇳🇿', zone:'Pacific/Auckland',     currency:'NZD', lat:-44.6411, lon:167.8972  },
  { key:'wellington',  kor:'웰링턴',     eng:'Wellington',     flag:'🇳🇿', zone:'Pacific/Auckland',     currency:'NZD', lat:-41.2924, lon:174.7787  },
  // ── 남미 ──
  { key:'lima',        kor:'리마',       eng:'Lima',           flag:'🇵🇪', zone:'America/Lima',         currency:'PEN', lat:-12.0464, lon:-77.0428  },
  { key:'machupicchu', kor:'마추픽추',   eng:'Machu Picchu',   flag:'🇵🇪', zone:'America/Lima',         currency:'PEN', lat:-13.1631, lon:-72.5450  },
  { key:'cusco',       kor:'쿠스코',     eng:'Cusco',          flag:'🇵🇪', zone:'America/Lima',         currency:'PEN', lat:-13.5319, lon:-71.9675  },
  { key:'buenosaires', kor:'부에노스아이레스',eng:'Buenos Aires',flag:'🇦🇷',zone:'America/Argentina/Buenos_Aires',currency:'ARS',lat:-34.6037,lon:-58.3816},
  { key:'patagonia',   kor:'파타고니아', eng:'Patagonia',      flag:'🇦🇷', zone:'America/Argentina/Buenos_Aires',currency:'ARS',lat:-50.0000,lon:-68.0000},
  { key:'iguazu',      kor:'이과수',     eng:'Iguazu Falls',   flag:'🇦🇷', zone:'America/Argentina/Buenos_Aires',currency:'ARS',lat:-25.6953,lon:-54.4367},
  { key:'rio',         kor:'리우데자네이루',eng:'Rio de Janeiro',flag:'🇧🇷',zone:'America/Sao_Paulo',   currency:'BRL', lat:-22.9068, lon:-43.1729  },
  { key:'amazon',      kor:'아마존',     eng:'Amazon',         flag:'🇧🇷', zone:'America/Manaus',       currency:'BRL', lat:-3.4653,  lon:-62.2159  },
  { key:'cartagena',   kor:'카르타헤나', eng:'Cartagena',      flag:'🇨🇴', zone:'America/Bogota',       currency:'COP', lat:10.3910,  lon:-75.4794  },
  { key:'bogota',      kor:'보고타',     eng:'Bogotá',         flag:'🇨🇴', zone:'America/Bogota',       currency:'COP', lat:4.7110,   lon:-74.0721  },
  { key:'medellin',    kor:'메데진',     eng:'Medellín',       flag:'🇨🇴', zone:'America/Bogota',       currency:'COP', lat:6.2442,   lon:-75.5812  },
  { key:'galapagos',   kor:'갈라파고스', eng:'Galapagos',      flag:'🇪🇨', zone:'Pacific/Galapagos',    currency:'USD', lat:-0.9538,  lon:-90.9656  },
  { key:'santiago',    kor:'산티아고',   eng:'Santiago',       flag:'🇨🇱', zone:'America/Santiago',     currency:'CLP', lat:-33.4489, lon:-70.6693  },
  { key:'atacama',     kor:'아타카마',   eng:'Atacama Desert', flag:'🇨🇱', zone:'America/Santiago',     currency:'CLP', lat:-23.8634, lon:-68.0000  },
  // ── 멕시코/카리브해 ──
  { key:'cancun',      kor:'칸쿤',       eng:'Cancún',         flag:'🇲🇽', zone:'America/Cancun',       currency:'MXN', lat:21.1619,  lon:-86.8515  },
  { key:'mexicocity',  kor:'멕시코시티', eng:'Mexico City',    flag:'🇲🇽', zone:'America/Mexico_City',  currency:'MXN', lat:19.4326,  lon:-99.1332  },
  { key:'oaxaca',      kor:'오악사카',   eng:'Oaxaca',         flag:'🇲🇽', zone:'America/Mexico_City',  currency:'MXN', lat:17.0732,  lon:-96.7266  },
  { key:'tulum',       kor:'툴룸',       eng:'Tulum',          flag:'🇲🇽', zone:'America/Cancun',       currency:'MXN', lat:20.2114,  lon:-87.4654  },
  { key:'havana',      kor:'아바나',     eng:'Havana',         flag:'🇨🇺', zone:'America/Havana',       currency:'CUP', lat:23.1136,  lon:-82.3666  },
];
...
const CITIES_BY_KEY = {
  ...
  italy:       [{kor:'로마',eng:'Rome'},{kor:'밀라노',eng:'Milan'},{kor:'베네치아',eng:'Venice'},{kor:'피렌체',eng:'Florence'},{kor:'나폴리',eng:'Naples'},{kor:'아말피',eng:'Amalfi'},{kor:'돌로미티',eng:'Dolomites'},{kor:'친퀘테레',eng:'Cinque Terre'},{kor:'토스카나',eng:'Tuscany'},{kor:'시칠리아',eng:'Sicily'},{kor:'볼로냐',eng:'Bologna'},{kor:'토리노',eng:'Turin'},{kor:'소렌토',eng:'Sorrento'},{kor:'시에나',eng:'Siena'},{kor:'아시시',eng:'Assisi'},{kor:'베로나',eng:'Verona'},{kor:'코모호수',eng:'Lake Como'},{kor:'포지타노',eng:'Positano'},{kor:'티볼리',eng:'Tivoli'},{kor:'팔레르모',eng:'Palermo'},{kor:'바리',eng:'Bari'},{kor:'제노바',eng:'Genoa'},{kor:'파르마',eng:'Parma'}],
