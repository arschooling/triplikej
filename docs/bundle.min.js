    ...
    React.useEffect(function () {
      ...
      fbLoadTrips(tripIds).then(/*#__PURE__*/function () {
        var _ref42 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(trips) {
          var normalized, primary, def, patch, first, _t8;
          return _regenerator().w(function (_context0) {
            while (1) switch (_context0.p = _context0.n) {
              case 0:
                ...
                primary = normalized.find(function (t) {
                  return t.id === userData.uid;
                }) || normalized[0];
                ...
                _context0.n = 2;
                return fbSaveGroup(primary.id, patch);
              case 2:
                normalized[normalized.indexOf(primary)] = normalizeTrip(_objectSpread(_objectSpread({}, primary), patch), primary.id);
                _context0.n = 4;
                break;
              case 3:
                _context0.p = 3;
                _t8 = _context0.v;
                console.warn('auto-init failed', _t8);
              case 4:
