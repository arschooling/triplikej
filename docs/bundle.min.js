...
(function (global, factory) {
  ...
  function TripsScreen(_ref17) {
    ...
    }, "v54")), /*#__PURE__*/React.createElement("button", {
    ...
    }), (trips.length === 0 || trips.every(function (t) {
      return !(t.days || []).length;
    })) && onRestore && /*#__PURE__*/React.createElement("div", {
      style: {
        padding: '28px 20px',
        background: COLORS.card,
        borderRadius: 20,
  ...
  function App() {
    var _nav$dayIdx, _nav$hotelIdx, _trip$days$dayIdx$her, _trip$days$dayIdx, _userTrips$find;
    var _nav = loadNav();
    ...
    React.useEffect(function () {
      ...
      fbLoadTrips(tripIds).then(/*#__PURE__*/function () {
        var _ref42 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(trips) {
          var normalized, i, def, patch, _t8;
          return _regenerator().w(function (_context0) {
            while (1) switch (_context0.p = _context0.n) {
              case 0:
                normalized = trips.map(function (t) {
              ...
              case 1:
                ...
                _context0.n = 3;
                return fbSaveGroup(normalized[i].id, patch);
              case 3:
                normalized[i] = normalizeTrip(_objectSpread(_objectSpread({}, normalized[i]), patch), normalized[i].id);
                _context0.n = 5;
                break;
              case 4:
                _context0.p = 4;
                _t8 = _context0.v;
                console.warn('auto-restore failed', _t8);
              case 5:
                i++;
                _context0.n = 1;
                break;
    ...
    React.useEffect(function () {
      ...
      return fbListenGroup(activeTripId, function (data) {
        var _tripRef$current;
        if (data === null) return;
        var incoming = normalizeTrip(data, activeTripId);
        // 기존에 days 있는데 Firestore가 빈 데이터 주면 무시 (쓰기 진행 중)
        if (incoming.days.length === 0 && (((_tripRef$current = tripRef.current) === null || _tripRef$current === void 0 || (_tripRef$current = _tripRef$current.days) === null || _tripRef$current === void 0 ? void 0 : _tripRef$current.length) || 0) > 0) return;
    ...
    var deleteTrip = /*#__PURE__*/function () {
      var _ref43 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0(tripId) {
        var t, isOwner, msg;
    ...
    if (tab === 'home') {
      if (hotelIdx !== null && trip) {
        ...
        screen = /*#__PURE__*/React.createElement(HomeScreen, {
          ...
          onLoadSample: /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
            var def, patch;
    ...
    if (!activeTripId) return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(TripsScreen, {
      ...
      onSelect: function onSelect(id) {
        ...
        fbLoadTrips([id]).then(function (trips) {
          if (!trips || !trips.length) return;
          var fresh = normalizeTrip(trips[0], id);
          tripRef.current = fresh;
          setTrip(fresh);
        }).catch(function () {});
      },
      onAdd: /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
        ...
        return _regenerator().w(function (_context11) {
          while (1) switch (_context11.n) {
            ...
            case 2:
              _yield$fbCreateNewTri = _context11.v;
      ...
      onRestore: /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11() {
        ...
        return _regenerator().w(function (_context12) {
          while (1) switch (_context12.n) {
            ...
            case 1:
              _yield$window$fbCreat = _context12.v;
    ...
    }, /*#__PURE__*/React.createElement("div", null, "tripId: ", activeTripId || 'none'), /*#__PURE__*/React.createElement("div", null, "trips loaded: ", userTrips.length), /*#__PURE__*/React.createElement("div", null, "found: ", userTrips.find(function (t) {
      return t.id === activeTripId;
    }) ? 'yes (days:' + (((_userTrips$find = userTrips.find(function (t) {
      return t.id === activeTripId;
    })) === null || _userTrips$find === void 0 || (_userTrips$find = _userTrips$find.days) === null || _userTrips$find === void 0 ? void 0 : _userTrips$find.length) || 0) + ')' : 'no')), /*#__PURE__*/React.createElement("button", {
      onClick: function onClick() {
        return fbLoadTrips([activeTripId]).then(function (ts) {
          if (ts[0]) {
            var t = normalizeTrip(ts[0], activeTripId);
            tripRef.current = t;
            setTrip(t);
          }
        });
    ...
    }, "Firestore\uC5D0\uC11C \uC9C1\uC811 \uBD88\uB7EC\uC624\uAE30"), /*#__PURE__*/React.createElement("div", {
      style: {
        width: 28,
        height: 28,
