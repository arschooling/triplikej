  ...
  return (
    <div style={{ minHeight:'100vh', background:COLORS.bg, paddingBottom:90, position:'relative' }}>
      ...
      <div style={{
        ...
        <div style={{ fontFamily:SERIF, fontSize:34, color:COLORS.ink, letterSpacing:'-0.02em' }}>My Trips<span style={{fontFamily:'monospace',fontSize:11,color:COLORS.mute,marginLeft:8}}>v382</span></div>
      </div>
      {loading
...
const CITIES_BY_KEY = {
  ...
  italy:       [{kor:'로마',eng:'Rome'},{kor:'밀라노',eng:'Milan'},{kor:'베네치아',eng:'Venice'},{kor:'피렌체',eng:'Florence'},{kor:'나폴리',eng:'Naples'},{kor:'아말피',eng:'Amalfi'},{kor:'돌로미티',eng:'Dolomites'},{kor:'친퀘테레',eng:'Cinque Terre'},{kor:'토스카나',eng:'Tuscany'},{kor:'시칠리아',eng:'Sicily'},{kor:'볼로냐',eng:'Bologna'},{kor:'토리노',eng:'Turin'},{kor:'소렌토',eng:'Sorrento'},{kor:'시에나',eng:'Siena'},{kor:'아시시',eng:'Assisi'},{kor:'베로나',eng:'Verona'},{kor:'코모호수',eng:'Lake Como'},{kor:'포지타노',eng:'Positano'},{kor:'팔레르모',eng:'Palermo'},{kor:'바리',eng:'Bari'},{kor:'제노바',eng:'Genoa'},{kor:'파르마',eng:'Parma'}],
